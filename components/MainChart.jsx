...
export default function Component(props) {
    ...
    const chartData = props.data.map(el => {
        return {
            ...
            lol: (el.lol - props.tracking.lol.start) / 0.506,
            ...
            <div className="p-3 bg-gray-800 shadow-md rounded-md border border-gray-700 text-xs text-gray-200 w-36">
                ...
                <div className="space-y-1">
                    <p className="flex justify-between">
                        ...
                        <span>
                            <span className="font-semibold" style={{ color: info.chess.color }}>{data.rawChess}</span>
                    ...
                    <p className="flex justify-between">
                        ...
                        <span>
                            <span className="font-semibold " style={{ color: info.duolingo.color }}>{data.rawDuolingo}</span>
                            <span className="" style={{ color: info.duolingo.color }}> XP</span>
                        </span>
                    </p>
                    <p className="flex justify-between">
                        <span className="text-gray-400">Money: </span>
                        <span>
                            <span className="font-semibold " style={{ color: info.money.color }}>{Math.round(data.rawMoney)}</span>
                            <span className="" style={{ color: info.money.color }}> €</span>
                        </span>
                    </p>
                    <p className="flex justify-between">
                        <span className="text-gray-400">LoL: </span>
                        <span>
                            <span className="font-semibold " style={{ color: info.lol.color }}>{data.rawLol}</span>
                            <span className="" style={{ color: info.lol.color }}> elo</span>
                        </span>
                    </p>
                    <p className="flex justify-between">
                        <span className="text-gray-400">Sport: </span>
                        <span>
                            <span className="font-semibold " style={{ color: info.sport.color }}>{data.rawSport}</span>
                            <span className="" style={{ color: info.sport.color }}> séances</span>
                        </span>
                    </p>
                </div>
            </div>
